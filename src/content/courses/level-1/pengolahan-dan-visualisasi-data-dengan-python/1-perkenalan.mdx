...
Untuk mengikuti course ini dengan baik, sangat direkomendasikan untuk mengikuti course ['Algoritma Menggunakan Python'](/web/level-1/algoritma-menggunakan-python?track=analisis-data) terlebih dahulu.
...
['Algoritma Menggunakan Python'](/web/level-1/algoritma-menggunakan-python?track=analisis-data).
