...
Selamat datang pada course 'Algoritma Menggunakan Python' ini! Setelah menyelesaikan course ini, kamu diharapkan sudah memahami dasar-dasar algoritma dan bisa melakukan pemrograman dasar menggunakan Python secara mandiri.
...
Memahami konsep algoritma dengan baik itu akan membentuk kerangka berpikir yang logis dan sistematis, sesuai dengan cara kerja komputer. Efeknya adalah, kita bisa jadi lebih kreatif dalam membuat program yang kompleks.

Selain itu, pemahaman yang baik konsep algoritma itu akan membuat belajar bahasa pemrograman baru jadi lebih mudah. Sebagai contoh, di bawah ini adalah perbandingan dari sintaks dari bahasa C dengan sintaks dari bahasa Python.
...
Meskipun berbeda sintaks, namun secara umum strukturnya masih mirip-mirip. Setelah mengikuti course ini, diharapkan kamu bukan hanya bisa pemrograman Python, tapi juga paham konsep algoritma yang bisa ditransfer saat belajar bahasa pemrograman lainnya.
...
<Alert variant="tip">
  ...
  software Python di komputer kamu masing-masing sangat penting untuk
  pekerjaan sehari-hari. Oleh karena itu, jangan lupa tetap berlatih menggunakan
