...
Selamat datang pada course 'Algoritma Menggunakan Python' ini! Setelah menyelesaikan course ini, kamu diharapkan sudah memahami dasar-dasar algoritma dan bisa melakukan pemrograman dasar menggunakan Python secara mandiri. Tanpa panjang lebar, yuk langsung ke bagian selanjutnya!
